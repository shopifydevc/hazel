	...
	return (
		...
		>
			...
			<path
				...
				stroke-linejoin="round"
				stroke-width="2"
				d="m9.736 10.873 1.875-.677c.23-.083.48-.083.71 0l1.902.687c.386.14.655.492.687.902l.079 1.027a3.83 3.83 0 0 1-1.994 3.66l-.519.281a1.04 1.04 0 0 1-1.014-.01l-.53-.303a3.83 3.83 0 0 1-1.93-3.473l.045-1.152c.016-.425.289-.797.689-.942Z"
				fill="none"
			/>
		</svg>
	)
