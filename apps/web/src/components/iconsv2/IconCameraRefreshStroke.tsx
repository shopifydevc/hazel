	...
	return (
		...
		>
			...
			<path
				...
				stroke-linejoin="round"
				stroke-width="2"
				d="M10.595 13.95c-.985-.43-1.636-.61-2.082-.464m0 0c-.554.181-.79.864-.96 2.19m.96-2.19a3.5 3.5 0 0 0 5.697 2.21m2.24-5.343c-.205 1.31-.457 1.986-1.006 2.16m0 0c-.45.142-1.099-.054-2.083-.514m2.083.514a3.5 3.5 0 0 0-2.195-2.774 3.5 3.5 0 0 0-3.493.557"
				fill="none"
			/>
		</svg>
	)
