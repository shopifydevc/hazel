...
export const IconMusicQuaverNoteRemove: Component<JSX.IntrinsicElements["svg"]> = (props) => {
	return (
		<svg
		...
		>
			<path
				...
				fill="currentColor"
			/>
			<path d="M4 6a1 1 0 1 0 0 2h6a1 1 0 1 0 0-2z" fill="currentColor" />
		</svg>
	)
}

export default IconMusicQuaverNoteRemove
