...
export const IconUturnDownDuoStroke: Component<JSX.IntrinsicElements["svg"]> = (props) => {
  return (
    <svg
      ...
      {...props}
    >
      <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 20V9a5 5 0 0 1 10 0v3" opacity=".28" fill="none"/><path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3.917 15.969a20.8 20.8 0 0 0 3.679 3.886.64.64 0 0 0 .809 0 20.8 20.8 0 0 0 3.678-3.886" fill="none"/>
    </svg>
  );
};
