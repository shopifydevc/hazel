...
export const IconUserEditDuoSolid: Component<JSX.IntrinsicElements["svg"]> = (props) => {
	return (
		...
		>
			<path
				fill="currentColor"
				d="M8 14h5.665l-2.085 2.084c-.325.322-.639.655-.883 1.045a4.5 4.5 0 0 0-.536 1.238c-.137.517-.15 1.037-.157 1.29q-.004.083-.004.167v1.18c0 .35.06.684.17.996H6a3 3 0 0 1-3-3 5 5 0 0 1 5-5Z"
				opacity=".28"
			/>
