...
export const IconFileCodeDuoSolid: Component<JSX.IntrinsicElements["svg"]> = (props) => {
	return (
		...
		>
			...
			<path
				fill="currentColor"
				d="M10.874 13.073a1 1 0 1 0-1.176-1.618 12.6 12.6 0 0 0-2.417 2.297 1.27 1.27 0 0 0 0 1.595c.698.867 1.51 1.639 2.417 2.297a1 1 0 1 0 1.175-1.618c-.6-.436-1.151-.931-1.644-1.476a10.7 10.7 0 0 1 1.645-1.477Z"
			/>
			<path
				fill="currentColor"
				d="M14.302 11.455a1 1 0 1 0-1.175 1.618c.6.436 1.151.931 1.644 1.477a10.7 10.7 0 0 1-1.645 1.476 1 1 0 1 0 1.176 1.618 12.6 12.6 0 0 0 2.416-2.297 1.27 1.27 0 0 0 0-1.595 12.6 12.6 0 0 0-2.416-2.297Z"
			/>
		</svg>
	)
}
