...
export const IconBallFootball1: Component<JSX.IntrinsicElements["svg"]> = (props) => {
	return (
		...
		>
			<path
				fill="currentColor"
				d="M17.733 17.73c2.62-2.62 3.37-6.58 3.498-9.73.063-1.56-.234-2.77-1.348-3.883C18.77 3.003 17.56 2.706 16 2.769c-3.15.127-7.11.879-9.73 3.498-2.618 2.618-3.37 6.58-3.497 9.73-.063 1.559.234 2.769 1.348 3.882 1.113 1.114 2.323 1.411 3.883 1.348 3.15-.127 7.11-.879 9.73-3.497Z"
				opacity=".28"
			/>
			<path
				stroke="currentColor"
