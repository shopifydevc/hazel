...
export const IconAirplaneDuoSolid: Component<JSX.IntrinsicElements["svg"]> = (props) => {
	return (
		<svg
		...
		>
			<path
				fill="currentColor"
				fill-rule="evenodd"
				d="M10 9.75a1 1 0 0 0-1.6-.8L2.6 13.3A4 4 0 0 0 1 16.5v.5a1 1 0 0 0 1.258.966l7-1.866a1 1 0 0 0 .742-.967zm5.6-.8a1 1 0 0 0-1.6.8v5.383a1 1 0 0 0 .742.967l7 1.866A1 1 0 0 0 23 17v-.5a4 4 0 0 0-1.6-3.2z"
				clip-rule="evenodd"
			/>
			<path
				fill="currentColor"
...
export default IconAirplaneDuoSolid
