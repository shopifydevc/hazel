...
export const IconEnvelopeArrowRight: Component<JSX.IntrinsicElements["svg"]> = (props) => {
	return (
		<svg
		...
		>
			...
			/>
			<path
				d="M22.948 8.905a.392.392 0 0 0-.608-.3l-5.668 3.607c-1.402.893-2.317 1.476-3.324 1.708a6 6 0 0 1-2.697 0c-1.006-.232-1.921-.815-3.323-1.708L1.66 8.605a.392.392 0 0 0-.608.3C1 9.73 1 10.702 1 11.872v.172c0 1.363 0 2.447.071 3.321.074.896.227 1.66.583 2.359a6 6 0 0 0 2.622 2.622c.7.356 1.463.51 2.359.583C7.509 21 8.593 21 9.956 21h3.214A3 3 0 0 1 16 17.001h.62a3 3 0 0 1 4.77-1.972q.753.566 1.43 1.212.073-.417.109-.876c.071-.874.071-1.958.071-3.321v-.172c0-1.17 0-2.143-.052-2.967Z"
				fill="currentColor"
			/>
			<path
				d="M23 20.001c0-.357-.12-.716-.358-1.01a14 14 0 0 0-2.452-2.361 1 1 0 0 0-1.2 1.6q.483.362.927.771H16a1 1 0 1 0 0 2h3.916q-.443.41-.926.772a1 1 0 0 0 1.2 1.6 14 14 0 0 0 2.452-2.362c.238-.294.358-.652.358-1.01Z"
				fill="currentColor"
			/>
		</svg>
	)
...
export default IconEnvelopeArrowRight
