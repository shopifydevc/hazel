...
export const IconSwapHalfarrowVerticalDuoStroke: Component<JSX.IntrinsicElements["svg"]> = (props) => {
  return (
    <svg
      ...
      {...props}
    >
      <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 3v15m4 3V6" opacity=".28" fill="none"/><path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 6.887A20.2 20.2 0 0 1 9.604 3.14.63.63 0 0 1 10 3m8 14.113a20.2 20.2 0 0 1-3.604 3.747A.63.63 0 0 1 14 21" fill="none"/>
    </svg>
  );
};
