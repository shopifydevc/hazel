...
export const IconEnvelopeRemoveDuoSolid: Component<JSX.IntrinsicElements["svg"]> = (props) => {
	return (
		...
		>
			<path
				fill="currentColor"
				d="M22.34 8.605a.392.392 0 0 1 .608.3C23 9.73 23 10.702 23 11.872v.172c0 1.363 0 2.447-.071 3.322-.067.816-.2 1.523-.493 2.172A2.5 2.5 0 0 0 22 17.5h-6a2.5 2.5 0 0 0-2.292 3.5H9.956c-1.363 0-2.447 0-3.321-.071-.896-.074-1.66-.227-2.359-.583a6 6 0 0 1-2.622-2.622c-.356-.7-.51-1.463-.583-2.358C1 14.49 1 13.406 1 12.044v-.172c0-1.17 0-2.143.052-2.967a.392.392 0 0 1 .608-.3l5.668 3.607c1.402.893 2.317 1.476 3.324 1.708a6 6 0 0 0 2.697 0c1.006-.232 1.921-.815 3.323-1.708z"
				opacity=".28"
			/>
			<path
				fill="currentColor"
			...
			/>
			<path fill="currentColor" d="M16 19a1 1 0 1 0 0 2h6a1 1 0 1 0 0-2z" />
		</svg>
	)
}
