...
export const IconCameraDuoSolid1: Component<JSX.IntrinsicElements["svg"]> = (props) => {
	return (
		<svg
		...
		>
			...
			<path
				fill="currentColor"
				fill-rule="evenodd"
				d="M18 10a1 1 0 0 0-2 0v.01a1 1 0 0 0 2 0zm-9.75 3a3.75 3.75 0 1 1 7.5 0 3.75 3.75 0 0 1-7.5 0Z"
				clip-rule="evenodd"
			/>
		</svg>
	)
...
export default IconCameraDuoSolid1
