...
export const IconPhotoImageArrowLeft1: Component<JSX.IntrinsicElements["svg"]> = (props) => {
	return (
		<svg
		...
		>
			<path
				fill="currentColor"
				d="M2.545 5.73C2 6.8 2 8.2 2 11v2c0 2.8 0 4.2.545 5.27a5 5 0 0 0 2.185 2.185c.78.398 1.738.505 3.287.534C8.59 21 9.244 21 10 21h3.357v-.438a3.61 3.61 0 0 1 .447-3.832 16 16 0 0 1 2.806-2.703 3 3 0 0 1 4.502 1.095h.874C22 14.516 22 13.818 22 13v-2l-.001-1c-.008-2.15-.068-3.336-.544-4.27a5 5 0 0 0-2.185-2.185C18.2 3 16.8 3 14 3h-4c-2.8 0-4.2 0-5.27.545A5 5 0 0 0 2.545 5.73Z"
				opacity=".28"
			/>
			<path
				stroke="currentColor"
