	...
	return (
		...
		>
			...
			<path
				...
				stroke-linejoin="round"
				stroke-width="2"
				d="M3 10.294C6.588 7.09 12.05 4.307 17.514 3.03c1.118-.261 1.753 1.234.789 1.858-3.946 2.55-8.186 5.744-11.089 9.453-.352.338.061.903.49.67 1.697-.92 3.462-1.905 5.296-2.662"
				fill="none"
			/>
		</svg>
	)
