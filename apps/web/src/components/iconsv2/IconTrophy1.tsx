...
export const IconTrophy1: Component<JSX.IntrinsicElements["svg"]> = (props) => {
	return (
		...
		>
			<path
				fill="currentColor"
				d="M15.4 3H8.6c-.558 0-.837 0-1.067.055a2 2 0 0 0-1.478 1.478 2.3 2.3 0 0 0-.05.467C6 5.158 6 5.351 6 5.6V10a6 6 0 0 0 6 6 6 6 0 0 0 6-6V5.6c0-.249 0-.442-.005-.6a2.3 2.3 0 0 0-.05-.467 2 2 0 0 0-1.478-1.478C16.237 3 15.957 3 15.4 3Z"
				opacity=".28"
			/>
			<path
				stroke="currentColor"
