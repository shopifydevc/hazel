...
export const IconPhotoImageCheck1: Component<JSX.IntrinsicElements["svg"]> = (props) => {
	return (
		...
		>
			<path
				fill="currentColor"
				d="M2 11c0-2.8 0-4.2.545-5.27A5 5 0 0 1 4.73 3.545C5.8 3 7.2 3 10 3h4c2.8 0 4.2 0 5.27.545a5 5 0 0 1 2.185 2.185c.476.934.536 2.12.544 4.27L22 11v2.5c-.584 0-1.174.169-1.692.523a16.7 16.7 0 0 0-2.82 2.428 3 3 0 0 0-4.312 4.023V21H10c-.756 0-1.41 0-1.983-.01-1.55-.03-2.506-.137-3.287-.535a5 5 0 0 1-2.185-2.185C2 17.2 2 15.8 2 13z"
				opacity=".28"
			/>
			<path
				stroke="currentColor"
