	...
	return (
		...
		>
			...
			<path
				...
				stroke-linejoin="round"
				stroke-width="2"
				d="m20.796 8.797-1.972-5.864a.62.62 0 0 0-1.18-.003l-1.762 5.157c-.145.425-.54.71-.982.71H9.1c-.443 0-.837-.285-.983-.71l-1.763-5.16a.62.62 0 0 0-1.18.002l-1.98 5.868"
				fill="none"
			/>
		</svg>
	)
