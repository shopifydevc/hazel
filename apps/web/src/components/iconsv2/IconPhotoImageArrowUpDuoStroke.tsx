	...
	return (
		...
		>
			...
			<path
				fill="currentColor"
				fill-rule="evenodd"
				d="M17.99 15.357a1.6 1.6 0 0 1 2.02 0c.884.716 1.677 1.54 2.361 2.451a1 1 0 1 1-1.6 1.2 12 12 0 0 0-.771-.926v3.916a1 1 0 1 1-2 0v-3.916q-.41.443-.771.926a1 1 0 0 1-1.6-1.2 14 14 0 0 1 2.361-2.451Z"
				clip-rule="evenodd"
			/>
			<path
				fill="currentColor"
