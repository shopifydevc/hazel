...
export const IconFileCancelDuoSolid: Component<JSX.IntrinsicElements["svg"]> = (props) => {
	return (
		...
		>
			...
			<path
				fill="currentColor"
				d="M15 1.282V3.2c0 .857 0 1.439.037 1.889.036.438.101.663.18.819a2 2 0 0 0 .875.874c.156.08.38.145.819.18C17.36 7 17.943 7 18.8 7h1.917a5 5 0 0 0-.454-.956c-.31-.506-.736-.931-1.35-1.545l-1.414-1.414c-.613-.613-1.038-1.038-1.544-1.348A5 5 0 0 0 15 1.282Z"
			/>
			<path
				fill="currentColor"
				d="M10.182 10.768a1 1 0 0 0-1.415 1.414l1.768 1.768-1.767 1.768a1 1 0 0 0 1.414 1.414l1.768-1.768 1.767 1.768a1 1 0 0 0 1.415-1.415l-1.768-1.767 1.768-1.768a1 1 0 0 0-1.415-1.414l-1.767 1.768z"
			/>
		</svg>
	)
}
