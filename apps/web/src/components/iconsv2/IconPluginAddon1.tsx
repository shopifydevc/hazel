...
export const IconPluginAddon1: Component<JSX.IntrinsicElements["svg"]> = (props) => {
	return (
		<svg
		...
		>
			<path
				fill="currentColor"
				d="M21 13.6v-2.4c0-1.12 0-1.68-.218-2.108a2 2 0 0 0-.874-.874c-.238-.121-.516-.175-.908-.199V5.6c0-.56 0-.84-.109-1.054a1 1 0 0 0-.437-.437C18.24 4 17.96 4 17.4 4h-1.8c-.56 0-.84 0-1.054.109a1 1 0 0 0-.437.437C14 4.76 14 5.04 14 5.6V8h-4V5.6c0-.56 0-.84-.109-1.054a1 1 0 0 0-.437-.437C9.24 4 8.96 4 8.4 4H6.6c-.56 0-.84 0-1.054.109a1 1 0 0 0-.437.437C5 4.76 5 5.04 5 5.6v2.42c-.392.023-.67.077-.908.198a2 2 0 0 0-.874.874C3 9.52 3 10.08 3 11.2v2.4c0 2.24 0 3.36.436 4.216a4 4 0 0 0 1.748 1.748C6.04 20 7.16 20 9.4 20h5.2c2.24 0 3.36 0 4.216-.436a4 4 0 0 0 1.748-1.748C21 16.96 21 15.84 21 13.6Z"
				opacity=".28"
			/>
			<path
				stroke="currentColor"
...
export default IconPluginAddon1
