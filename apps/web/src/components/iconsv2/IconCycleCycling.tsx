...
export const IconCycleCycling: Component<JSX.IntrinsicElements["svg"]> = (props) => {
	return (
		<svg
			...
			{...props}
		>
			<path d="M14.5 6a3 3 0 1 1 6 0 3 3 0 0 1-6 0Z" fill="currentColor" />
			<path d="M18.5 13.5a4 4 0 1 0 0 8 4 4 0 0 0 0-8Z" fill="currentColor" />
			<path d="M1.5 17.5a4 4 0 1 1 8 0 4 4 0 0 1-8 0Z" fill="currentColor" />
			<path
...
export default IconCycleCycling
