	...
	return (
		...
		>
			<g fill="currentColor" opacity=".3">
				<path
					fill="currentColor"
					d="M2.38 10.087C2 11.005 2 12.17 2 14.5c0 1.33 0 2.495.38 3.413a5 5 0 0 0 2.707 2.706C6.005 21 7.17 21 9.5 21h3.582v-.234a3.6 3.6 0 0 1 .722-3.033 16 16 0 0 1 2.806-2.703 3 3 0 0 1 4.465 1.02h.899C22 15.566 22 15.048 22 14.5c0-2.33 0-3.495-.38-4.413a5 5 0 0 0-2.707-2.706A4 4 0 0 0 18 7.13C17.195 7 16.134 7 14.5 7h-5c-2.33 0-3.495 0-4.413.38a5 5 0 0 0-2.706 2.707Z"
				/>
				<path fill="currentColor" d="M21.38 17.001V17h.493v.001z" />
			</g>
			<path
				stroke="currentColor"
				fill="none"
