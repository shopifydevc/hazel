...
export const IconWalletPlus1: Component<JSX.IntrinsicElements["svg"]> = (props) => {
	return (
		...
		>
			<path
				fill="currentColor"
				d="M2.38 10.087C2 11.005 2 12.17 2 14.5c0 1.33 0 2.495.38 3.413a5 5 0 0 0 2.707 2.706C6.005 21 7.17 21 9.5 21h3.895v-.512a3 3 0 0 1 7.844-6.486v-.186h.76c-.003-1.883-.038-2.905-.38-3.73a5 5 0 0 0-2.706-2.705A4 4 0 0 0 18 7.13C17.195 7 16.134 7 14.5 7h-5c-2.33 0-3.495 0-4.413.38a5 5 0 0 0-2.706 2.707Z"
				opacity=".28"
			/>
			<path
				stroke="currentColor"
