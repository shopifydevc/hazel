...
export const IconSidebarRightClose: Component<JSX.IntrinsicElements["svg"]> = (props) => {
	return (
		<svg
		...
		>
			<path
				d="M8.088 8.191a1 1 0 1 0-1.176 1.618c.882.64 1.685 1.376 2.392 2.191-.707.815-1.51 1.55-2.392 2.191a1 1 0 1 0 1.176 1.618A16.3 16.3 0 0 0 11.2 12.85c.4-.497.4-1.203 0-1.7a16.3 16.3 0 0 0-3.112-2.96Z"
				fill="currentColor"
			/>
			<path
				fill-rule="evenodd"
...
export default IconSidebarRightClose
