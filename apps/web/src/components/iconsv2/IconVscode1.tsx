	...
	return (
		...
		>
			<path
				fill="currentColor"
				fill-rule="evenodd"
				d="m17 3 3.231 1.616c.642.32.963.481 1.198.72a2 2 0 0 1 .462.748C22 6.4 22 6.76 22 7.478v9.044c0 .718 0 1.077-.11 1.394a2 2 0 0 1-.461.747c-.235.24-.556.4-1.198.721L17 21l-7.789-7.01L4 18l-2-1.5L7 12 2 7.5 4 6l5.212 4.01zm-5.201 9L17 7.996V16z"
				clip-rule="evenodd"
				opacity=".28"
			/>
			<path
