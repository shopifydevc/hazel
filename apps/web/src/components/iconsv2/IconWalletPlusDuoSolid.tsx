...
export const IconWalletPlusDuoSolid: Component<JSX.IntrinsicElements["svg"]> = (props) => {
	return (
		<svg
		...
		>
			...
			<path
				...
				stroke-width="2"
				d="M14 12h3m2 10v-3m0 0v-3m0 3h-3m3 0h3"
			/>
		</svg>
	)
}

export default IconWalletPlusDuoSolid
