...
export const IconLayersTo1: Component<JSX.IntrinsicElements["svg"]> = (props) => {
	return (
		...
		>
			<path
				fill="currentColor"
				d="m2.05 5.957-.05 7.5c-.012 1.802 1.603 3.163 3.343 2.819l.207-.041-.002.214c-.012 1.802 1.603 3.163 3.343 2.82l.206-.042-.001.213c-.011 1.802 1.603 3.164 3.343 2.819l7.242-1.436c1.31-.26 2.26-1.422 2.269-2.78l.05-7.5c.012-1.802-1.603-3.164-3.343-2.819l-.207.041.002-.212c.012-1.803-1.603-3.164-3.343-2.82l-.206.042.001-.215c.012-1.802-1.603-3.164-3.343-2.819L4.319 3.177c-1.31.26-2.26 1.423-2.269 2.78Z"
				opacity=".28"
			/>
			<path
				stroke="currentColor"
