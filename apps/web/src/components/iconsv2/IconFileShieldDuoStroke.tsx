	...
	return (
		...
		>
			...
			<path
				...
				stroke-linejoin="round"
				stroke-width="2"
				d="m9.736 11.74 1.875-.678c.23-.083.48-.083.71 0l1.902.687c.386.14.655.493.687.902l.079 1.027a3.83 3.83 0 0 1-1.994 3.66l-.519.282a1.04 1.04 0 0 1-1.014-.012l-.53-.301a3.83 3.83 0 0 1-1.93-3.474l.045-1.152c.016-.424.289-.797.689-.942Z"
				fill="none"
			/>
		</svg>
	)
