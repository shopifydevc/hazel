...
export const IconEnvelopeArrowDown1: Component<JSX.IntrinsicElements["svg"]> = (props) => {
	return (
		<svg
		...
		>
			<path
				fill="currentColor"
				d="M10 4h4c2.8 0 4.2 0 5.27.545a5 5 0 0 1 2.185 2.185C22 7.8 22 9.2 22 12v.392h-.52a3 3 0 0 0-4.48 2.61v.62a3 3 0 0 0-2.377 4.033V20H10c-2.8 0-4.2 0-5.27-.545a5 5 0 0 1-2.185-2.185C2 16.2 2 14.8 2 12s0-4.2.545-5.27A5 5 0 0 1 4.73 4.545C5.8 4 7.2 4 10 4Z"
				opacity=".28"
			/>
			<path
				stroke="currentColor"
...
export default IconEnvelopeArrowDown1
