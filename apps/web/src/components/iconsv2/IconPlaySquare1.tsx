	...
	return (
		...
		>
			...
			<path
				...
				stroke-linejoin="round"
				stroke-width="2"
				d="M9.5 11.896c0-1.432 0-2.148.3-2.547a1.5 1.5 0 0 1 1.093-.598c.498-.035 1.1.352 2.305 1.126l.162.104c1.045.672 1.567 1.008 1.748 1.435a1.5 1.5 0 0 1 0 1.168c-.18.427-.703.763-1.748 1.435l-.162.104c-1.205.774-1.807 1.161-2.305 1.126A1.5 1.5 0 0 1 9.8 14.65c-.299-.4-.299-1.115-.299-2.547z"
			/>
		</svg>
	)
}
