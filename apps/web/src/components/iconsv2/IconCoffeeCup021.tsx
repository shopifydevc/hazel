...
export const IconCoffeeCup021: Component<JSX.IntrinsicElements["svg"]> = (props) => {
	return (
		...
		>
			<path
				fill="currentColor"
				d="M18 12.353V11.6c0-.25 0-.443-.01-.6-.012-.196-.038-.335-.099-.454a1 1 0 0 0-.437-.437C17.24 10 16.96 10 16.4 10H3.6c-.56 0-.84 0-1.054.109a1 1 0 0 0-.437.437C2 10.76 2 11.04 2 11.6v.753a8 8 0 0 0 16 0Z"
				opacity=".28"
			/>
			<path
				stroke="currentColor"
