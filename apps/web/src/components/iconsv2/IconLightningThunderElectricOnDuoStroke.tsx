	...
	return (
		...
		>
			...
			<path
				...
				stroke-linejoin="round"
				stroke-width="2"
				d="m6.054 8.38 5.756-4.513c1.638-1.284 2.457-1.926 3.017-1.863.486.055.913.366 1.137.828.26.533-.003 1.58-.53 3.673m2.473 9.338-5.652 4.343c-1.628 1.25-2.442 1.876-3 1.81a1.46 1.46 0 0 1-1.13-.831c-.256-.532.004-1.565.523-3.63"
				fill="none"
			/>
		</svg>
	)
