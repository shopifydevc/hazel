...
export const IconPhotoImageRemoveDuoSolid: Component<JSX.IntrinsicElements["svg"]> = (props) => {
	return (
		...
		>
			...
			<path
				fill="currentColor"
				d="M20.993 9.25h-.054c-1.335 0-2.067 0-2.692.064A12.25 12.25 0 0 0 7.346 19.97c.694.029 1.548.03 2.654.03h3.17A3 3 0 0 1 16 16h4.95c.05-.753.05-1.703.05-3v-2c0-.669 0-1.245-.007-1.75Z"
			/>
