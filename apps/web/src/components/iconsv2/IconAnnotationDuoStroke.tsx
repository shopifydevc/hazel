...
export const IconAnnotationDuoStroke: Component<JSX.IntrinsicElements["svg"]> = (props) => {
	return (
		<svg
		...
		>
			...
			<path
				...
				stroke-linejoin="round"
				stroke-width="2"
				d="M5.714 18.152c.57.09 1.149.002 1.72.055a1.9 1.9 0 0 1 1.232.616c.334.37.611.802.91 1.2.824 1.1 1.237 1.651 1.743 1.848a1.9 1.9 0 0 0 1.377 0c.506-.197.919-.747 1.744-1.848.298-.398.575-.83.91-1.2a1.9 1.9 0 0 1 1.232-.616c.57-.053 1.15.035 1.72-.055"
				fill="none"
			/>
		</svg>
	)
...
export default IconAnnotationDuoStroke
