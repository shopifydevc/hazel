	...
	return (
		...
		>
			<path
				...
				stroke-width="2"
				d="M12 20h-2c-2.8 0-4.2 0-5.27-.545a5 5 0 0 1-2.185-2.185C2 16.2 2 14.8 2 12c0-1.994 0-3.278.197-4.238m19.606 0C22 8.722 22 10.006 22 12c0 1.524 0 2.633-.088 3.5"
				opacity=".28"
				fill="none"
			/>
			<path
