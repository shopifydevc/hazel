...
export const IconBuildingApartmentTwo1: Component<JSX.IntrinsicElements["svg"]> = (props) => {
	return (
		<svg
		...
		>
			<path
				fill="currentColor"
				d="M10.8 2H6.2c-1.12 0-1.68 0-2.108.218a2 2 0 0 0-.874.874C3 3.52 3 4.08 3 5.2v15.2c0 .56 0 .84.109 1.054a1 1 0 0 0 .437.437C3.76 22 4.04 22 4.6 22h7.8c.56 0 .84 0 1.054-.109a1 1 0 0 0 .437-.437C14 21.24 14 20.96 14 20.4V5.2c0-1.12 0-1.68-.218-2.108a2 2 0 0 0-.874-.874C12.48 2 11.92 2 10.8 2Z"
				opacity=".28"
			/>
			<path
				stroke="currentColor"
...
export default IconBuildingApartmentTwo1
