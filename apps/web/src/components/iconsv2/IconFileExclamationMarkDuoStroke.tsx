	...
	return (
		...
		>
			...
			<path
				...
				stroke-linejoin="round"
				stroke-width="2"
				d="M12 15v-4m0 7.01V18m2-15.942V3.2c0 1.68 0 2.52.327 3.162a3 3 0 0 0 1.311 1.311C16.28 8 17.12 8 18.8 8h1.142a3 3 0 0 0-.052-.277 4 4 0 0 0-.48-1.156c-.247-.404-.593-.75-1.285-1.441l-1.25-1.251c-.692-.692-1.038-1.038-1.442-1.285a4 4 0 0 0-1.156-.48A3 3 0 0 0 14 2.059Z"
				fill="none"
			/>
		</svg>
	)
