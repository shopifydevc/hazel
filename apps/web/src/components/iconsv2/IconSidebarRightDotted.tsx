...
export const IconSidebarRightDotted: Component<JSX.IntrinsicElements["svg"]> = (props) => {
	return (
		...
		>
			<path
				fill="currentColor"
				d="M21 11v2c0 2.8 0 4.201-.545 5.27a5 5 0 0 1-2.185 2.186c-.778.396-1.73.504-3.27.534V3.012c1.54.03 2.492.137 3.27.534a5 5 0 0 1 2.185 2.185C21 6.8 21 8.2 21 11Z"
				opacity=".28"
			/>
			<path
				stroke="currentColor"
