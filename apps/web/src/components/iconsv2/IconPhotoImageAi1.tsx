	...
	return (
		...
		>
			<g fill="currentColor" opacity=".28">
				<path
					fill="currentColor"
					d="M2.545 5.73C2 6.8 2 8.2 2 11v2c0 2.8 0 4.2.545 5.27a5 5 0 0 0 2.185 2.185c.78.398 1.738.505 3.287.534C8.59 21 9.244 21 10 21h3c0-1.062.552-1.996 1.385-2.529A3 3 0 0 1 15.9 14.21c.62-.244.793-.4.856-.462.064-.064.213-.236.454-.848A3 3 0 0 1 20 11h2l-.001-1c-.008-2.15-.068-3.336-.544-4.27a5 5 0 0 0-2.185-2.185C18.2 3 16.8 3 14 3h-4c-2.8 0-4.2 0-5.27.545A5 5 0 0 0 2.545 5.73Z"
				/>
				<path
					fill="currentColor"
					d="M23 17c-1.66-.655-2.363-1.383-3-3-.637 1.617-1.34 2.345-3 3 1.66.655 2.363 1.384 3 3 .637-1.616 1.34-2.345 3-3Z"
				/>
			</g>
			<path
				stroke="currentColor"
