	...
	return (
		...
		>
			...
			<path
				...
				stroke-linejoin="round"
				stroke-width="2"
				d="m9.215 12.476 2.678-5.087c.177-.338.683-.21.683.172v3.103c0 .098.038.19.106.26a.36.36 0 0 0 .257.107l1.525.002a.368.368 0 0 1 .317.547l-2.795 5.038c-.183.33-.68.199-.68-.18v-3.055a.365.365 0 0 0-.363-.367H9.534a.368.368 0 0 1-.32-.54Z"
				fill="none"
			/>
		</svg>
	)
