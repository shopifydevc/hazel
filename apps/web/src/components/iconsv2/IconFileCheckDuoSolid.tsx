...
export const IconFileCheckDuoSolid: Component<JSX.IntrinsicElements["svg"]> = (props) => {
	return (
		...
		>
			...
			<path
				fill="currentColor"
				d="M16.463 12.895a1 1 0 1 0-1.128-1.652 16 16 0 0 0-4.174 4.168L9.707 13.96a1 1 0 0 0-1.414 1.415l2.342 2.338a1 1 0 0 0 1.574-.21 14 14 0 0 1 4.254-4.607Z"
			/>
		</svg>
	)
}
