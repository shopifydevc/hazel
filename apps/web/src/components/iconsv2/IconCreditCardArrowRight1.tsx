...
export const IconCreditCardArrowRight1: Component<JSX.IntrinsicElements["svg"]> = (props) => {
	return (
		...
		>
			<path
				fill="currentColor"
				d="M2 10.4c0-2.24 0-3.36.436-4.216a4 4 0 0 1 1.748-1.748C5.04 4 6.16 4 8.4 4h7.2c2.24 0 3.36 0 4.216.436a4 4 0 0 1 1.748 1.748C22 7.04 22 8.16 22 10.4v3.2c0 .537 0 1.01-.006 1.43h-.605A3 3 0 0 0 16.62 17H16a3 3 0 0 0-3 3H8.4c-2.24 0-3.36 0-4.216-.436a4 4 0 0 1-1.748-1.748C2 16.96 2 15.84 2 13.6z"
				opacity=".28"
			/>
			<path
				stroke="currentColor"
