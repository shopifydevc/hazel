...
export const IconFramerDuoSolid: Component<JSX.IntrinsicElements["svg"]> = (props) => {
	return (
		<svg
		...
		>
			...
			<path
				fill="currentColor"
				d="M13 16H5a1 1 0 0 1-.753-.341l5.624 6.426c.195.223.382.437.546.595.139.133.448.421.896.478a1.5 1.5 0 0 0 1.308-.492c.3-.337.343-.758.36-.95.02-.226.02-.51.02-.807z"
			/>
		</svg>
	)
}

export default IconFramerDuoSolid
