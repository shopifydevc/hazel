...
export const IconSidebarLeftCloseDuoSolid: Component<JSX.IntrinsicElements["svg"]> = (props) => {
	return (
		...
		>
			...
			<path
				fill="currentColor"
				d="M15.912 8.191a1 1 0 0 1 1.176 1.618A14.3 14.3 0 0 0 14.696 12c.707.815 1.51 1.55 2.392 2.191a1 1 0 0 1-1.176 1.618A16.3 16.3 0 0 1 12.8 12.85c-.4-.497-.4-1.203 0-1.7a16.3 16.3 0 0 1 3.112-2.959Z"
			/>
		</svg>
	)
}
