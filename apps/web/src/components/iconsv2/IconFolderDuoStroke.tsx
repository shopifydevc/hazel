...
export const IconFolderDuoStroke: Component<JSX.IntrinsicElements["svg"]> = (props) => {
	return (
		<svg
		...
		>
			...
			<path
				...
				stroke-linejoin="round"
				stroke-width="2"
				d="M22 12v2.6c0 2.24 0 3.36-.436 4.216a4 4 0 0 1-1.748 1.748C18.96 21 17.84 21 15.6 21H8.4c-2.24 0-3.36 0-4.216-.436a4 4 0 0 1-1.748-1.748C2 17.96 2 16.84 2 14.6V12"
				fill="none"
			/>
		</svg>
	)
...
export default IconFolderDuoStroke
