...
export const IconUturnRightDuoStroke: Component<JSX.IntrinsicElements["svg"]> = (props) => {
  return (
    <svg
      ...
      {...props}
    >
      <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M20 8H9a5 5 0 0 0 0 10h3" opacity=".28" fill="none"/><path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15.969 3.916a20.8 20.8 0 0 1 3.886 3.679.64.64 0 0 1 0 .809 20.8 20.8 0 0 1-3.886 3.679" fill="none"/>
    </svg>
  );
};
