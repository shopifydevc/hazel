...
export const IconNftProfileUserDuoSolid: Component<JSX.IntrinsicElements["svg"]> = (props) => {
	return (
		<svg
		...
		>
			<path
				...
				opacity=".28"
			/>
			<path fill="currentColor" d="M12 6.25a2.75 2.75 0 1 0 0 5.5 2.75 2.75 0 0 0 0-5.5Z" />
			<path
				fill="currentColor"
				d="M10 13.25A2.75 2.75 0 0 0 7.25 16c0 .966.784 1.75 1.75 1.75h6A1.75 1.75 0 0 0 16.75 16 2.75 2.75 0 0 0 14 13.25z"
			/>
		</svg>
	)
}

export default IconNftProfileUserDuoSolid
