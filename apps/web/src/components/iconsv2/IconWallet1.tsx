...
export const IconWallet1: Component<JSX.IntrinsicElements["svg"]> = (props) => {
	return (
		<svg
		...
		>
			<path
				fill="currentColor"
				d="M2 14.5c0-2.33 0-3.495.38-4.413A5 5 0 0 1 5.088 7.38C6.005 7 7.17 7 9.5 7h5c1.634 0 2.695 0 3.5.131.343.056.639.136.913.25a5 5 0 0 1 2.706 2.706C22 11.005 22 12.17 22 14.5c0 1.33 0 2.495-.38 3.413a5 5 0 0 1-2.707 2.706C17.995 21 16.83 21 14.5 21h-5c-2.33 0-3.495 0-4.413-.38a5 5 0 0 1-2.706-2.707C2 16.995 2 15.83 2 14.5Z"
				opacity=".28"
			/>
			<path
				stroke="currentColor"
