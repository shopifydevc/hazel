...
export const IconPhotoImageArrowUp: Component<JSX.IntrinsicElements["svg"]> = (props) => {
	return (
		...
		>
			...
			/>
			<path
				d="M19 14.999c-.358 0-.716.12-1.01.357a14 14 0 0 0-2.361 2.452 1 1 0 1 0 1.6 1.2q.362-.483.77-.926v3.916a1 1 0 1 0 2 0v-3.916q.41.443.772.926a1 1 0 0 0 1.6-1.2 14 14 0 0 0-2.361-2.451 1.6 1.6 0 0 0-1.01-.358Z"
				fill="currentColor"
			/>
		</svg>
	)
