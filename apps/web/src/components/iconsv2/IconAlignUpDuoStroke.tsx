...
export const IconAlignUpDuoStroke: Component<JSX.IntrinsicElements["svg"]> = (props) => {
  return (
    <svg
      ...
      {...props}
    >
      <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 4h14" opacity=".28" fill="none"/><path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7.917 12.03a20.8 20.8 0 0 1 3.679-3.885A.64.64 0 0 1 12 8m4.083 4.03a20.8 20.8 0 0 0-3.678-3.885A.64.64 0 0 0 12 8m0 0v12" fill="none"/>
    </svg>
  );
};
