	...
	return (
		...
		>
			<path
				fill="currentColor"
				fill-rule="evenodd"
				d="M19 9.75c0 3-1.95 5.25-7 5.25s-7-2.25-7-5.25a6.3 6.3 0 0 1 .68-3c-.34-1.47-.21-3.28.52-3.64s2.27.3 3.54 1.15a13 13 0 0 1 2.26-.2 13 13 0 0 1 2.26.18c1.27-.85 2.88-1.48 3.54-1.15s.86 2.17.52 3.64A6.3 6.3 0 0 1 19 9.75Z"
				clip-rule="evenodd"
				opacity=".28"
			/>
			<path
