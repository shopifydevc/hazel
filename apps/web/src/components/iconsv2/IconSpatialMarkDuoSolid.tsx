...
export const IconSpatialMarkDuoSolid: Component<JSX.IntrinsicElements["svg"]> = (props) => {
	return (
		...
		>
			<path
				fill="currentColor"
				d="M13.943 1.935a4 4 0 0 0-3.886 0l-6 3.334A4 4 0 0 0 2 8.765v6.47a4 4 0 0 0 2.057 3.496l6 3.334a4 4 0 0 0 3.886 0l6-3.334A4 4 0 0 0 22 15.235v-6.47a4 4 0 0 0-2.057-3.496z"
				opacity=".28"
			/>
			<path
				fill="currentColor"
