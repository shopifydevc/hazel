import { Dialog as ArkDialog } from "@ark-ui/solid" // Using Dialog for Sheet functionality
...
const SidebarProvider: Component<SidebarProviderProps> = (props) => {
	...
	const sidebarStyle = createMemo(() => {
		...
		if (typeof local.style === "string") {
			// This is a basic attempt; might need a more robust CSS string parser
			console.warn("String style prop might not merge correctly with CSS variables.")
...
// --- Menu Button ---
type SidebarMenuButtonProps = JSX.ButtonHTMLAttributes<HTMLButtonElement> &
