...
export const styles = {
	secondary:
		"bg-primary text-fg-quaternary shadow-xs-skeumorphic inset-ring inset-ring-primary hover:bg-primary_hover hover:text-fg-quaternary_hover disabled:shadow-xs disabled:ring-disabled_subtle",
