...
export const IconFile02SearchDuoSolid: React.FC<SVGProps<SVGSVGElement>> = (props) => {
	return (
		<svg
		...
		>
			...
			<path
				fill="currentColor"
				fillRule="evenodd"
				d="M12 10c-2.21 0-4 1.789-4 4a3.998 3.998 0 0 0 6.032 3.446l.76.76a1 1 0 1 0 1.415-1.414l-.76-.76A3.998 3.998 0 0 0 12 10Zm-2 4c0-1.107.894-2 2-2a1.998 1.998 0 0 1 1.414 3.414A1.998 1.998 0 0 1 10 14Z"
				clipRule="evenodd"
			/>
		</svg>
	)
...
export default IconFile02SearchDuoSolid
