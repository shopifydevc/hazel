...
export const IconStarDuoSolid: React.FC<SVGProps<SVGSVGElement>> = (props) => {
	return (
		<svg
		...
		>
			...
			<path
				...
				strokeWidth="2"
				d="M2.687 10.801a2.06 2.06 0 0 1 .642-1.975m3.954 12.168a2.06 2.06 0 0 1-1.68-1.22m12.795 0c-.3.68-.942 1.145-1.68 1.22M20.67 8.826c.554.495.8 1.249.642 1.975m-8.274-7.52a2.06 2.06 0 0 0-2.077 0"
			/>
		</svg>
	)
}

export default IconStarDuoSolid
