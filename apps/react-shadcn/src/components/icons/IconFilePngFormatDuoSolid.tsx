...
export const IconFilePngFormatDuoSolid: React.FC<SVGProps<SVGSVGElement>> = (props) => {
	return (
		<svg
		...
		>
			...
			<path
				fill="currentColor"
				d="M10.868 13.504A1 1 0 0 0 9 14v7a1 1 0 1 0 2 0v-3.234l2.132 3.73A1 1 0 0 0 15 21v-7a1 1 0 1 0-2 0v3.234z"
			/>
			<path
				fill="currentColor"
				fillRule="evenodd"
...
export default IconFilePngFormatDuoSolid
