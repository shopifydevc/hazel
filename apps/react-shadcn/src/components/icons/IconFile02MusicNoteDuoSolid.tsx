...
export const IconFile02MusicNoteDuoSolid: React.FC<SVGProps<SVGSVGElement>> = (props) => {
	return (
		<svg
		...
		>
			...
			<path
				fill="currentColor"
				fillRule="evenodd"
				d="M14 13.023c0-.763-.38-1.467-1-1.888V17.5a2.5 2.5 0 1 1-2-2.451v-4.228a1.82 1.82 0 0 1 2.634-1.629A4.28 4.28 0 0 1 16 13.023c0 .651-.134 1.295-.4 1.888a1 1 0 0 1-1.824-.822A2.6 2.6 0 0 0 14 13.023ZM10.5 17a.5.5 0 1 1 0 1 .5.5 0 0 1 0-1Z"
				clipRule="evenodd"
			/>
		</svg>
	)
...
export default IconFile02MusicNoteDuoSolid
