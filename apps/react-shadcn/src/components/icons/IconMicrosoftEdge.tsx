...
export const IconMicrosoftEdge: React.FC<SVGProps<SVGSVGElement>> = (props) => {
	return (
		<svg
		...
		>
			<path
				fill="currentColor"
				d="M12.106 9.605c-.51 0-1.091.217-1.663.602-.29.267-.727.855-.727 1.99 0 4.924 6.938 7.342 10.414 4.872.469-.411.991.035.697.482-1.823 2.792-5.147 4.072-8.721 4.072a9.622 9.622 0 1 1 7.52-15.65c2.956 3.68 2.757 9.257-3.08 9.257-1.5 0-2.84-.451-2.84-1.117 0-.858.857-.665.857-2.095l-.027-.273s-.438-2.14-2.43-2.14Z"
				opacity=".28"
			/>
			<path
				stroke="currentColor"
