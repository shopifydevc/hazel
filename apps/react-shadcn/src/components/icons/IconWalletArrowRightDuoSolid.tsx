...
export const IconWalletArrowRightDuoSolid: React.FC<SVGProps<SVGSVGElement>> = (props) => {
	return (
		<svg
		...
		>
			...
			<path
				...
				strokeWidth="2"
				d="M14 12h3m2.59 10.573a13 13 0 0 0 2.275-2.191.6.6 0 0 0 .135-.38m-2.41-2.572c.846.634 1.61 1.37 2.275 2.191.09.111.135.246.135.38m0 0h-6"
			/>
		</svg>
	)
}

export default IconWalletArrowRightDuoSolid
