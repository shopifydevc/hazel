...
export const IconFile02ArrowLeft: React.FC<SVGProps<SVGSVGElement>> = (props) => {
	return (
		<svg
		...
		>
			<path
				fillRule="evenodd"
				d="M8 1h1.2c.857 0 1.439 0 1.889.038.438.035.663.1.819.18a2 2 0 0 1 .874.874c.08.156.145.38.18.819C13 3.361 13 3.943 13 4.8v.039c0 .527 0 .981.03 1.356.033.395.104.789.297 1.167a3 3 0 0 0 1.311 1.311c.378.193.772.264 1.167.296.375.031.83.031 1.356.031h.039c.857 0 1.439 0 1.889.038.438.035.663.1.819.18a2 2 0 0 1 .874.874c.08.156.145.38.18.819.037.45.038 1.032.038 1.889V18a5 5 0 0 1-5 5H8a5 5 0 0 1-5-5V6a5 5 0 0 1 5-5Zm3.474 11.8a1 1 0 0 0-1.2-1.6 11 11 0 0 0-1.946 1.875 1.47 1.47 0 0 0 0 1.85 11 11 0 0 0 1.946 1.875 1 1 0 0 0 1.2-1.6 9 9 0 0 1-.257-.2H15a1 1 0 1 0 0-2h-3.783q.127-.102.257-.2Z"
				clipRule="evenodd"
				fill="currentColor"
			/>
			<path
...
export default IconFile02ArrowLeft
