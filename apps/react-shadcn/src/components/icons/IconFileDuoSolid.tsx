...
export const IconFileDuoSolid: React.FC<SVGProps<SVGSVGElement>> = (props) => {
	return (
		<svg
		...
		>
			...
			<path
				fill="currentColor"
				d="M15 3.2V1.282q.501.177.956.455c.506.31.93.735 1.544 1.348L18.913 4.5c.615.614 1.04 1.04 1.35 1.545q.278.455.454.956H18.8c-.857 0-1.439 0-1.889-.038-.438-.035-.663-.1-.819-.18a2 2 0 0 1-.874-.874c-.08-.156-.145-.38-.18-.82C15 4.639 15 4.058 15 3.2Z"
			/>
		</svg>
	)
}

export default IconFileDuoSolid
