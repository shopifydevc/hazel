...
export const IconCreditCardPlus: React.FC<SVGProps<SVGSVGElement>> = (props) => {
	return (
		<svg
		...
		>
			...
			<path
				fillRule="evenodd"
				d="M23 10H1v3.643c0 1.084 0 1.958.058 2.666.06.729.185 1.369.487 1.961a5 5 0 0 0 2.185 2.185c.592.302 1.233.428 1.961.487C6.4 21 7.273 21 8.357 21h5.407A3 3 0 1 1 22 16c.333 0 .654.054.954.155.046-.68.046-1.506.046-2.512zM4.85 13a1 1 0 0 1 1-1h3.3a1 1 0 1 1 0 2h-3.3a1 1 0 0 1-1-1Z"
				clipRule="evenodd"
				fill="currentColor"
			/>
			<path
